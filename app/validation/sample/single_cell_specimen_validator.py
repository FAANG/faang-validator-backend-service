...
class SingleCellSpecimenValidator(BaseValidator):
    ...
    def export_to_biosample_format(self, model: FAANGSingleCellSpecimenSample) -> Dict[str, Any]:
        ...
        excluded_fields = {
            'sample_name', 'material', 'term_source_id', 'tissue_dissociation', 'cell_enrichment',
            'enrichment_markers', 'cell_type', 'single_cell_isolation', 'single_cell_entity',
            'single_cell_quality', 'cell_number', 'cell_number_unit', 'single_cell_isolation_protocol',
